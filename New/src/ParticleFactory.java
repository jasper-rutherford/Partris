...
public class ParticleFactory
{
    ...
    public static Particle generateParticle(String type, Particle prevParticle)
    {
        ...
        {
            System.out.println("tried to create particle with unknown type: " + type);
            return null;
        }
    }

    //generates an air particle with a previous type which is also air
    public static Particle generateAirParticle(Point indices)
    {
    ...
    {
        System.out.println("getting color of " + type);
